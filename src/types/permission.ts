...
export type CrudField = "can_create" | "can_read" | "can_update" | "can_delete" | "can_move_treasury" | "can_see_treasury"
...
export const CRUD_FIELDS: { key: CrudField; label: string }[] = [
  ...
  { key: "can_move_treasury", label: "M" },
  { key: "can_see_treasury",  label: "S" },
]
